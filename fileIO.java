...
public class fileIO {
	public static int readFile(String pFileName, journeyClass journey, DSAGraph graph, int option) {
		int cantFind = 0;
		int count = 0;
		String line;
		...
		try {
			...
			while (line != null) {
				...
				} else if (option == 2) {				//if imported option is 1, populates graph with read file 
														//if imported option is 2, opoulates journey with read file
					count++;
